...
(function() {
  var SOCKET_TEMPLATE, _cpFile, _ensureExists, _insertTempl, cp2Folder, err, fs, getTempl, insertSocket, path, res500, rmFile, sortAlphaNum, sortFiles, tempCache;
  ...
  insertSocket = function(file) {
    return _insertTempl(file, [SOCKET_TEMPLATE]);
  };
  ...
  exports.SOCKET_TEMPLATE = SOCKET_TEMPLATE;
