...
(function() {
  var SOCKET_TEMPLATE, createServer, ejs, err, f5DeleteFile, fs, getTempl, http, insertSocket, insertTempl, io, path, renderDir, res500, sortAlphaNum, sortFiles, tempCache, types, url, watcher;
