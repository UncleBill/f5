...
(function() {
  var SOCKET_TEMPLATE, createServer, ejs, f5DeleteFile, fs, getTempl, http, insertSocket, insertTempl, io, path, renderDir, res500, sortAlphaNum, sortFiles, types, url, watcher;
