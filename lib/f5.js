...
(function() {
  var SOCKET_TEMPLATE, cp2Folder, cpFile, createServer, ejs, ensureExists, err, f5DeleteFile, fs, getTempl, http, insertSocket, insertTempl, io, path, querystring, renderDir, res500, sortAlphaNum, sortFiles, tempCache, types, url, utils, watcher;
